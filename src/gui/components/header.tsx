...
export default function Header({...props }) {
    return (
        <header className="sticky top-0 z-50 flex flex-row w-full justify-between bg-inherit">
            ...
            <div className="flex flex-row items-center justify-center">
                <Link href="/#test_project_cards" className="text-slate-800 hover:text-slate-500">Projects</Link>
            </div>
